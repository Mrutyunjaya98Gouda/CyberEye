  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 font-mono",
  {
    variants: {
      variant: {
        ...
        warning: "border-transparent bg-accent/20 text-accent border-accent/30",
        info: "border-transparent bg-info/20 text-info border-info/30",
        cyber: "border-primary/50 bg-primary/10 text-primary",
        anomaly: "border-destructive/50 bg-destructive/10 text-destructive",
        cloud: "border-info/50 bg-info/10 text-info",
      },
    },
    defaultVariants: {
      variant: "default",
